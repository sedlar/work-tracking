...
def test_get_missing_objects(objects_tracker_model):
    assert objects_tracker_model.get_objects_types([ObjectId(OBJECT_ID1)]) == {}


def test_get_missing_object(objects_tracker_model):
    assert not objects_tracker_model.get_object_type(ObjectId(OBJECT_ID1))
...
def test_get_object_types_by_project(objects_tracker_model, put_project):
    ...
    assert objects_tracker_model.get_objects_types_by_project(object_id1.project_id) == {
        object_id1: ObjectType.deliverable,
    }
